...
abstract class CustomFieldBaseRequest extends FormRequest
{
    ...
    protected function getCommonRules(array $validTypes, array $validModels): array
    {
        ...
        return array_merge(
            ...
            $this->getSlugRules($customFieldId),
    ...
    protected function getSlugRules($customFieldId): array
    {
        return [
            'slug' => [
                'nullable',
    ...
    protected function customFieldMessages(): array
    {
        return [
            ...
            'slug.unique' => 'A field with this slug already exists for the selected model.',
        ];
    }
